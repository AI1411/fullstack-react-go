...
export const getRegisterResponseMock = (overrideResponse: Partial< HandlerRegisterResponse > = {}): HandlerRegisterResponse => ({token: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), user: faker.helpers.arrayElement([{created_at: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), email: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), id: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), name: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), organizations: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({created_at: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), description: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), name: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), parent_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), prefecture_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), type: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), updated_at: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), users: faker.helpers.arrayElement([[], undefined])})), undefined]), role_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), updated_at: faker.helpers.arrayElement([faker.string.alpha(20), undefined])}, undefined]), ...overrideResponse})
...
export const getListDisastersResponseMock = (): HandlerListDisastersResponse[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({disasters: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({address: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), affected_area_size: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), estimated_damage_amount: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), id: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), latitude: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), longitude: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), municipality: faker.helpers.arrayElement([{id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), is_active: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), municipality_name_kana: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), municipality_name_kanji: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), organization_code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), prefecture_code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), prefecture_name_kana: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), prefecture_name_kanji: faker.helpers.arrayElement([faker.string.alpha(20), undefined])}, undefined]), municipality_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), name: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), occurred_at: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), place_id: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), status: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), summary: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), timelines: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({})), undefined]), work_category: faker.helpers.arrayElement([{category_name: faker.string.alpha(20), icon_name: faker.string.alpha(20)}, undefined]), work_category_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})), undefined]), total: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})))

export const getCreateDisasterResponseMock = (overrideResponse: Partial< HandlerListDisastersResponse > = {}): HandlerListDisastersResponse => ({disasters: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({address: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), affected_area_size: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), estimated_damage_amount: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), id: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), latitude: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), longitude: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), municipality: faker.helpers.arrayElement([{id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), is_active: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), municipality_name_kana: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), municipality_name_kanji: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), organization_code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), prefecture_code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), prefecture_name_kana: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), prefecture_name_kanji: faker.helpers.arrayElement([faker.string.alpha(20), undefined])}, undefined]), municipality_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), name: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), occurred_at: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), place_id: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), status: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), summary: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), timelines: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({})), undefined]), work_category: faker.helpers.arrayElement([{category_name: faker.string.alpha(20), icon_name: faker.string.alpha(20)}, undefined]), work_category_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})), undefined]), total: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), ...overrideResponse})
...
export const getRegisterMockHandler = (overrideResponse?: HandlerRegisterResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<HandlerRegisterResponse> | HandlerRegisterResponse)) => {
