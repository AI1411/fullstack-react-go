...
$$
    ...
    BEGIN
        ...
        -- 令和6年7月豪雨関連のタイムライン
        INSERT INTO timelines (disaster_id, event_name, event_time, description, severity)
        VALUES (disaster_id1, '大雨特別警報発令', '2024-07-09 18:00:00',
                '気象庁から東京都全域に大雨特別警報が発令された。', '高'),
               (disaster_id1, '河川氾濫警戒情報', '2024-07-10 02:30:00', '〇〇川の水位が上昇し、氾濫警戒水位に到達。',
                '中'),
               (disaster_id1, '堤防決壊発生', '2024-07-10 05:45:00',
                '〇〇川の堤防が一部決壊し、周辺農地への浸水が始まった。', '高'),
               (disaster_id1, '浸水被害拡大', '2024-07-10 08:30:00', '浸水エリアが拡大し、水田約150ヘクタールが冠水。',
                '高'),
               (disaster_id1, '排水作業開始', '2024-07-11 06:00:00',
                '水位低下に伴い、排水ポンプ車による排水作業が開始された。', '中'),
               (disaster_id1, '被害状況調査開始', '2024-07-12 09:00:00',
                '農林水産省と都の合同チームによる被害状況調査が開始された。', '低');

        -- 春季霜害関連のタイムライン
        INSERT INTO timelines (disaster_id, event_name, event_time, description, severity)
        VALUES (disaster_id2, '低温注意報発令', '2024-04-17 16:00:00', '翌朝の冷え込みに関する低温注意報が発令された。',
                '低'),
               (disaster_id2, '霜害発生', '2024-04-18 04:30:00',
                '早朝の気温が-2℃まで低下し、りんご園に広範囲の霜被害が発生。', '高'),
               (disaster_id2, '被害第一報', '2024-04-18 08:30:00',
                'JAから県に対して霜害の第一報が入った。開花中の花芽に甚大な被害。', '高'),
               (disaster_id2, '緊急対策会議', '2024-04-18 13:00:00', '県庁で関係機関による緊急対策会議が開催された。',
                '中'),
               (disaster_id2, '専門家チーム派遣', '2024-04-19 10:00:00',
                '農業技術専門家チームが被害状況の詳細調査のため現地に派遣された。', '中'),
               (disaster_id2, '被害状況報告書提出', '2024-04-25 15:00:00',
                '詳細な被害状況と今後の見通しに関する報告書が県に提出された。', '低');

        -- 夏季干ばつ関連のタイムライン
        INSERT INTO timelines (disaster_id, event_name, event_time, description, severity)
        VALUES (disaster_id3, '少雨傾向の警告', '2023-07-20 10:00:00',
                '気象庁から長期間の少雨傾向が続く予報が発表された。', '低'),
               (disaster_id3, '干ばつ注意報', '2023-07-30 12:00:00', '北海道南部を中心に干ばつ注意報が発令された。',
                '中'),
               (disaster_id3, '生育障害の発生', '2023-08-05 09:00:00',
                'じゃがいも、とうもろこしなどの畑作物に生育障害が発生し始めた。', '中'),
               (disaster_id3, '断水対策開始', '2023-08-10 08:00:00',
                '一部地域で農業用水の取水制限が始まり、断水対策が開始された。', '高'),
               (disaster_id3, '緊急灌水支援', '2023-08-15 14:00:00', '自衛隊による給水支援と緊急灌水作業が開始された。',
                '高'),
               (disaster_id3, '被害状況確定', '2023-09-20 15:30:00',
                '干ばつによる収穫量減少と品質低下の最終的な被害状況が確定した。', '中');

        -- 台風15号関連のタイムライン
        INSERT INTO timelines (disaster_id, event_name, event_time, description, severity)
        VALUES (disaster_id4, '台風発生', '2024-09-05 10:00:00',
                '南の海上で台風15号が発生。進路予測では日本に接近する見込み。', '低'),
               (disaster_id4, '暴風警報発令', '2024-09-08 12:00:00', '千葉県全域に暴風警報が発令された。', '中'),
               (disaster_id4, '農業施設対策指示', '2024-09-08 14:30:00',
                '県からビニールハウスなど農業施設の補強・避難対策の指示が出された。', '中'),
               (disaster_id4, '台風最接近', '2024-09-08 22:00:00', '台風15号が千葉県に最接近。最大瞬間風速40m/sを記録。',
                '高'),
               (disaster_id4, '施設被害発生', '2024-09-08 23:30:00',
                '強風によりビニールハウスの倒壊や農業倉庫の屋根損壊が発生。', '高'),
               (disaster_id4, '被害状況調査', '2024-09-09 07:00:00',
                '台風通過後、県とJAによる被害状況の緊急調査が開始された。', '中');

        -- 地滑り関連のタイムライン
        INSERT INTO timelines (disaster_id, event_name, event_time, description, severity)
        VALUES (disaster_id5, '大雨警報発令', '2023-06-29 15:00:00', '石川県に大雨警報が発令された。', '中'),
               (disaster_id5, '土砂災害警戒情報', '2023-06-29 20:30:00',
                '土砂災害警戒情報が発表され、警戒レベル4相当に引き上げられた。', '高'),
               ...
               (disaster_id5, '二次災害防止措置', '2023-06-30 10:00:00',
                '専門家チームによる二次災害防止のための緊急措置が開始された。', '中'),
               (disaster_id5, '復旧計画策定開始', '2023-07-05 13:00:00',
                '被災した棚田の復旧計画策定のための検討会が開催された。', '低');
    END
$$;
