...
type notification struct {
	...
	RelatedEntityType field.String // 関連エンティティ種別 - 通知に関連するエンティティの種類
	RelatedEntityID   field.String // 関連エンティティID - 通知に関連するエンティティのID
	IsRead            field.Bool   // 既読フラグ - 通知が既読かどうか
	ReadAt            field.Time   // 既読日時 - 通知が既読になった日時
