...
type UserRole struct {
	UserID    string    `gorm:"column:user_id;type:uuid;primaryKey;index:idx_user_roles_user_id,priority:1;comment:ユーザーID - ユーザーテーブルの外部キー" json:"user_id"`      // ユーザーID - ユーザーテーブルの外部キー
