...
type Disaster struct {
	...
	Status                string         `gorm:"column:status;type:character varying(20);not null;index:idx_disasters_status,priority:1;comment:状態 - 審査中, 対応中, 査定完了, 完了などの現在の状況" json:"status"`                                 // 状態 - 審査中, 対応中, 査定完了, 完了などの現在の状況
